...
import resumeaimatchImage from "@/assets/resumematch.png";
import cinematchImage from "@/assets/cinematch.png";
import ripplerentImage from "@/assets/ripplerent.png";
import remedyflowImage from "@/assets/remedyflow.png";
import medicinematchImage from "@/assets/medicinematch.png";
import portfolioImage from "@/assets/aumkarportfolio.png";

const projects = [
  {
    title: "Resume AI Match",
    description:
      "An AI-powered resume analyzer that matches candidates with job descriptions and provides intelligent feedback for better alignment.",
    image: resumeaimatchImage,
  ...
  },
  {
    title: "RecommendPro",
    description:
      "A movie recommendation engine leveraging collaborative filtering and TMDB API to deliver personalized film suggestions.",
  ...
  },
  {
    title: "Ripple Rent",
    description:
      "A modern property rental platform that simplifies apartment searches with dynamic filters and responsive design.",
    image: ripplerentImage,
  ...
  },
  {
    ...
    description:
      "A fully responsive personal portfolio showcasing projects, experience, and interactive animations built with modern web technologies.",
  ...
  },
  {
    title: "MedicineMatch",
    description:
      "An intelligent medicine recommendation web app that suggests alternatives and provides comprehensive details on prescriptions.",
    image: medicinematchImage,
  ...
  },
  {
    title: "RemedyFlow",
    description:
      "A health-based recommendation system that finds remedies and related medicine data using AI-driven natural language understanding.",
    image: remedyflowImage,
    tech: ["React", "FastAPI", "OpenAI"],
